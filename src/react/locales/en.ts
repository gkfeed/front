const en = {
  ...
  creator: {
    ...
    typeDetectionError: 'Could not detect the type. Select it manually.',
  ...
  live: {
    ...
    noProviders: 'Live integrations are disabled',
    noProvidersText: 'Enable Twitch, HLTV, or OneFootball in Settings to find live events.',
  ...
  settings: {
    ...
    tiktokPlayback: 'TikTok player',
    tiktokPlaybackDescription: 'Preview supports 2× for videos longer than a minute.',
    tiktokEmbed: 'Embed',
    tiktokPreview: 'Preview',
  ...
  preview: {
    ...
    openTemporaryLink: 'Open temporary link',
    sound: 'Tap for sound',
    open: 'Open {{hostname}}',
    ...
    youtubeEmbedUnavailable: 'YouTube preview unavailable',
    youtubeEmbedError: 'YouTube blocked or could not load the embedded player.',
